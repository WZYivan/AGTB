...
int main()
{
    ...
    test_inverse_length_general<age::IE1975>(B_45_deg, 1e-2);

    std::println("Testing IE1975 (Specified Option) Inverse with higher precision:");
    test_inverse_length_general<age::IE1975>(B_45_deg, 1e-5);
    test_inverse_length_general<age::IE1975>(B_45_deg, std::numeric_limits<double>::epsilon());
