...
int main()
{
    aat::TraverseParam<aa::RouteType::Closed> p1{
        .distances = {105.22, 80.18, 129.34, 78.16},
        .angles = {{107, 48, 30}, {73, 0, 24}, {89, 33, 48}, {89, 36, 30}},
        .azi_beg = {125, 30, 0},
        .x_beg = 506.32,
        .y_beg = 215.65};
    auto r1 = aat::Adjust(p1, 2);
    std::println(">>> Closed:\n{}", aat::TraverseAdjustTable(p1, r1));

    aat::TraverseParam<aa::RouteType::Connecting> p2{
        ...
        .x_end = 2166.70,
        .y_end = 1757.28};
    auto r2 = aat::Adjust(p2, 2);

    std::println(">>> Connecting:\n{}", aat::TraverseAdjustTable(p2, r2));
}
```
