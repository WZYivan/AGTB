#ifndef __AGTB_GEODESY_BASE_COORDINATE_SYSTEM_HPP__
#define __AGTB_GEODESY_BASE_COORDINATE_SYSTEM_HPP__
...
/**
 * @brief Project Coordinate System
 *
 */
enum class ProjCs
{
 ...
 */
template <GaussZoneInterval interval>
Longitude GaussProjCenterLongitude(int zone)
{
    AGTB_TEMPLATE_NOT_SPECIFIED();
}

template <>
Longitude GaussProjCenterLongitude<GaussZoneInterval::D6>(int zone)
{
    return FromDMS(6 * zone - 3);
}

template <>
Longitude GaussProjCenterLongitude<GaussZoneInterval::D3>(int zone)
{
 ...
 */
template <GaussZoneInterval interval>
int GaussProjZone(Longitude L)
{
    AGTB_TEMPLATE_NOT_SPECIFIED();
}

template <>
int GaussProjZone<GaussZoneInterval::D6>(Longitude L)
{
    return int(L.Rad() / FromDMS(6.0)) + 1;
}

template <>
int GaussProjZone<GaussZoneInterval::D3>(Longitude L)
{
...
Longitude GaussProjCenterLongitude(Longitude l)
{
