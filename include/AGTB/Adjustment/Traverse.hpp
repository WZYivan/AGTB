...
#if (AGTB_DEBUG)
        std::println("f_beta / n = {}", (-info.f_beta / angles.size()).ToString());
        std::println("ang_seconds = {} a_sum = {} da_sum = {}, f_beta = {}", ang_seconds, va.a_sum.ToString(), va.da_sum.ToString(), info.f_beta.ToString());
#endif
